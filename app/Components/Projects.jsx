...
const Projects = () => {
    return (
        <div className=''>
            <div className='text-7xl  roboto-slab-600 text-white border-b-2 p-2 mx-[8%] tracking-wider'>PROJECTS</div>
            <div className='grid grid-cols-2 ubuntu-regular gap-10 mx-30 mt-15'>
                <div className='px-8 py-4 max-h-[480px] backdrop-blur-sm backdrop-brightness-150 rounded-xl'>
                    <section className='text-3xl text-center font-bold mb-7  tracking-wide '>Digital Compliance Management System</section>
                    <section className='tracking-wide text-[#FFD700]'>Tech Stack: React.js, Node.js, Express, MongoDB, TailwindCSS, JWT, Nodemailer</section>
                ...
                <div className='px-8 py-4 max-h-[480px]  backdrop-blur-sm backdrop-brightness-150 rounded-xl'>
                    <section className='text-3xl font-bold flex justify-center  mb-7 tracking-wide'>Sewage Management System</section>
                    <section className='tracking-wide mt-2  text-[#FFD700]'>Tech Stack: React.js, Node.js, Express, MongoDB, TailwindCSS, JWT, Cloudinary</section>
                    <section className='ml-6 mt-2'>
                        <ul className='list-disc text-md'>
                            <li>Developed a full-stack sewage complaint management system using React.js, Node.js, Express, and MongoDB.</li>
                ...
                <div className='px-8 py-6 max-h-[480px] backdrop-blur-sm backdrop-brightness-150 rounded-xl'>
                    <section className='text-3xl flex justify-center mb-7 font-extrabold tracking-wide'>E-Commerce Website</section>
                    <section className='tracking-wide mt-2 text-[#FFD700]'>Tech Stack: React.js, Node.js, Express, MongoDB, TailwindCSS, JWT</section>
                    <section className='ml-6 mt-2'>
                        <ul className='list-disc text-md'>
